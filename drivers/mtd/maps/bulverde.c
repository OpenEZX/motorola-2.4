 ...
 * Modified:	2006/04/05
 * 		- Change memory layout for martinique
 */
...
static struct mtd_partition bulverde_partitions[] = {
	{
		...
		name:		"USERFS_DB",
		size:		0x00600000,
		offset:		0x00B40000, /* JFFS2 userdb size is 6MB*/
	},{
		name:		"USERFS_GENERAL",
		size:		0x00AE0000,
		offset:		0x01140000, /* JFFS2 userfs size is 11MB */
	},{
		name:		"TEST_CMD",
		size:		0x00020000,
		offset:		0x01C60000,
		...
		name:		"FOTA",
		size:		0x000C0000,
		offset:		0x01CA0000, //FOTA partition is 0xc0000 -- 768KB
	},{
		name:		"RESERVE",
		size:		0x00020000,
		offset:		0x01D60000, //Boot Panic log -- 128KB
	}
};
#else
static struct mtd_partition bulverde_partitions[] = {
