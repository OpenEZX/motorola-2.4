 ...
 * Motorola 2005-Nov-29 - Remove of emu_eoc.h
 * Motorola 2006-Jan-19 - Copyright info cleanup.
 * Motorola 2006-Jul-03 - Add ioctl for GPO4_REG for ATLAS
...
#define GPO4_REG             POWER_IC_REG_NUM_REGS_PCAP /*invalid for pcap */
...
#define GPO4_REG             POWER_IC_REG_ATLAS_PWR_MISC
#endif /* ATLAS */
...
{       
    ...
    switch(cmd)  {
        ...
        case POWER_IC_IOCTL_CMD_TCMD_GPO4_EXT_VOLTAGE_OUTPUT:
            ...
            tracemsg(_k_d("Set the GPO4 bits to %d"),(int)val);
            ret_val =  power_ic_write_reg_value(GPO4_REG, val);
            break;
