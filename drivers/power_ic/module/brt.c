/*
 * /vobs/ezx_linux/code/linux/linux-2.4.17/drivers/power_ic/module/brt.c
 *
 * Description - Battery ROM Data interface.
 *
...
/*! Local constants for BRT interface */
#define BIT_ACCESS                       1
...
#define ROM_PART_ID_INDEX                0
#define ROM_MANUFACURE_ID_MSB_INDEX      6
#define ROM_MANUFACURE_ID_LSB_INDEX      5

#define MEM_CRC_LENGTH                   1
#define MEM_CRC_INDEX                    0
#define MEM_BIT_COUNT                    64

#define BRT_DALLAS_2502_ID               0x89
#define BRT_MANUFACURE_ID_MSB            0x50
#define BRT_MANUFACURE_ID_LSB            0x00

#define MAX_NUM_RETRY_READ               4

#define BATT_AUX_SEL                     0x2F
#define MAIN_BATT_PRESENT                0

#define NUM_SERIAL_NUMBER_DATA           3
#define NUM_SECURITY_EPROM_DATA          8

#define BRT_PAGE_SIZE 0x20

/*! This structure defines the states of read procedure on battery rom */
enum
{
    BATT_DETECT = 0,
    BATT_IDENTIFY,
...
/*! This is the list of commands used to read battery data from one wire device */
 ...
 *
 * @param        serial_number_index    pointer to brt serial numer index 
 * @param        bit
 */
 ...
 *
 * This function identifies the battery rom data and determine if valid battery present.
 *
 ...
 *
 * This function will handle sending commands to the battery eprom through
