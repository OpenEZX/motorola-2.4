/*
 * drivers/power_ic/module/debounce.c
 *
...
#ifdef CONFIG_MOT_POWER_IC_BARREL_HEADSET_STEREO_3MM5
/*!
 * @brief timer timeout function to fix the hardware bug of 3.5mm headset jack
 *
 * Workaround:
 * ===========
 * In the current hardware design of 4-pole 3.5mm headset, an unexpected send/end
