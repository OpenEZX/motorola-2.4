...
/* HACK HACK HACK 
   All of this code for Atlas is a complete hack because for Atlas 2.1 and 3.0
   you have to write the register multiple times to get it to work.*/
#elif defined(CONFIG_MOT_POWER_IC_ATLAS)
    int stdac;
    ...
    /* On Atlas 3.0 writing to the Stdac register just once doesn't work, so we have to 
       write multiple times */ 
    power_ic_set_reg_mask(ST_DAC, stdac, stdac);
    ...
    return (power_ic_set_reg_mask(ST_DAC, stdac, stdac));
/* HACK HACK HACK */
#endif
}
