...
#define __BRT_H__
/*
 * /vobs/ezx_linux/code/linux/linux-2.4.17/drivers/power_ic/module/brt.h
 *
 * Description - This is the header of internal definitions of battery rom data interface.
 *
