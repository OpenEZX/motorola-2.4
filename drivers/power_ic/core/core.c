 ...
 * Motorola 2005-May-12 - Add Touchscreen and TCMD support.                                  
 ...
 * Motorola 2006-May-26 - Modification to AUX1/AUX2/AUX3/AUX4 for power saving.
 * Motorola 2006-Jul-03 - Merge OSS cleanup to macau in kernel.
 * Motorola 2006-Jul-16 - Add PengLai product.
...
static const unsigned int tab_init_reg[NUM_INIT_REGS][2] =
{
    ...
    {POWER_IC_REG_PCAP_AUX_VREG,       0x1025B4c},
#else
    {POWER_IC_REG_PCAP_AUX_VREG,       0x1024BEC},
#endif /* CONFIG_ARCH_EZX_MACAU */ 
    ...
    {POWER_IC_REG_ATLAS_REG_MODE_1,        0x003F009},
