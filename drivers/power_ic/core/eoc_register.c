 ...
 *  Author     Date                Comment
 * ======== ===========   =====================================================
 * Motorola 2004-Dec-06 - Design the  Low level interface to EMU One Chip IC.
 * Motorola 2005-Mar-25 - Cycle thru different addresses for EMU one chip.
 * Motorola 2006-Jan-10 - Finalize the design for the EMU one chip interface. 
