 ...
 *
 * Motorola 07/02/2003      created file
 * Motorola 10/01/2005      modified for EZX platform
...
/* modify bt uart interface;define a new structure and several varibles*/
typedef struct
{
int  bt_Sample_Value;
    int  bt_Step_Value;
		    ...
		    unsigned int cmd, unsigned long arg)
{
	...
	switch (cmd) {
		...
		case TIOCSERSWILD:
			...
			return 0;
		case TIOC_BT_VOLTAGE_ON:   //for Barbados 
		#ifdef BT_DEBUG
			printk("\nBT_voltage_on\n");
		#endif
#ifdef CONFIG_MOT_POWER_IC
...
#endif
			return 0;
		case TIOC_BT_VOLTAGE_OFF: //for Barbados  
		#ifdef BT_DEBUG
			printk("\nBT_voltage_off\n");
		#endif
#ifdef CONFIG_MOT_POWER_IC
