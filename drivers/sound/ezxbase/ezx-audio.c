 ...
 *  History:
 *  Jun 20,2002         created
 *  Sep 23,2003         (1)Port from EZX
 *  Mar.15,2004		mixer bug fix
 *  Apr.13,2004		close dsp protection,and add 3d control interface for app
 *  Jun.15,2004		boomer's power management
 *  Aug.11,2004		DMA channel release bug fix
 *  Mar.10,2005		Change the debug log for barbados
 *  Apr.11,2006		Bug fix of sleep issue when audio is working
 *  Jun.04,2007		Modify the algorithm of buffer allocation
 *  Oct.30,2007     Removing last changes for buffer allocation algorithm
 *
 */
