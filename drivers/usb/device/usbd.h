...
/*
 * RECV_SETUP return value
 * Should not change the first two values.
 */
/* The function has handled the setup packet, return to interrupt handler now. */
#define USB_RECV_SETUP_DONE             0x00
/* The function has no handler to process */
#define USB_RECV_SETUP_NOHANDLER        0x01
/* This function won't handle the setup packet, go ahead */
#define USB_RECV_SETUP_CONTINUE         0x02
/* The function wants to handle the setup packet but the data is not ready, pending and return. */
#define USB_RECV_SETUP_PENDING          0x03
...
/* Type of selected function driver. */
#define USBD_NETWORK 1
#define USBD_SERIAL 2
extern int usbd_function;
