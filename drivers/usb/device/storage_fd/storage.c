 ...
 */
static __devinitdata struct usb_alternate_description storage_data_alternate_descriptions[] = {
 ...
 */
static __devinitdata struct usb_interface_description storage_interfaces[] = {
 ...
 */
struct __devinitdata usb_configuration_description storage_description[] = {
...
/* Device Description
 */
struct __devinitdata usb_device_description storage_device_description = {
    bDeviceClass:       0, 
    bDeviceSubClass:    0,
    bDeviceProtocol:    0,
