 ...
 *
 *  History:
 *  Motorola          Api.11,2002,  create for ezx platform
 *  Motorola           July.12,2005,  remove warning code
 *
 */

/*
 * Linux Flash read-only block device driver For Cramfs file system, support simultaneous linear + block device mounting.  -- Mar, 15 2002
