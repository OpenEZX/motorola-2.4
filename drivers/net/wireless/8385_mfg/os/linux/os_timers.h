...
{
	struct timer_list 	tl __ATTRIB_PACK__;
	void			(*timer_function)(void *context)__ATTRIB_PACK__;
	void			*function_context __ATTRIB_PACK__;
	UINT 			time_period __ATTRIB_PACK__;
	BOOLEAN 		timer_is_periodic __ATTRIB_PACK__;
	BOOLEAN 		timer_is_canceled __ATTRIB_PACK__;
