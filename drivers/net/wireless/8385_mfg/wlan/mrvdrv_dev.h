...
typedef struct _wlan_adapter
{
	...
	PBSS_DESCRIPTION_SET_ALL_FIELDS BssDescList;
	...
	u32 			DirectedFramesRcvOK;
	u32 			RxBytes; /* For netstat */
	u32 			TxBytes; /* For netstat */
	...
	u32 			CurrentWepKeyIndex; 

#ifdef WPA
	WPA_SUPPLICANT		wpa_supplicant[MRVDRV_MAX_BSSID_LIST];
#ifdef WPA2
	WPA_SUPPLICANT		wpa2_supplicant[MRVDRV_MAX_BSSID_LIST];
#endif /* WPA2 */
