...
/*
	File	: msd25_sdio.h
  * $Id: //depot/MRVL/main/driver/WLan/Drv/MSI/Linux/src/if/if_sdio/msd25_sdio.h#2 $
*/

#ifndef	_MSD25_SDIO_H_
#define	_MSD25_SDIO_H_
...
/* Special registers in function 0 of the SD25 card */
...
int mv_sdio_host_to_card(wlan_private *priv, u8 type, u8 *payload, int nb);
