/*
 * File: sdio.h
 * This file contains the structure definations for the low level SDIO driver
...
EXTERN int sdio_enter_bus_powersave(mmc_card_t);
EXTERN int sdio_exit_bus_powersave(mmc_card_t);
