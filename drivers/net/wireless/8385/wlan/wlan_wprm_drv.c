 ...
 *
 * Revision History:
 * Author        Tracking No.      Date        Description
 * Guodong,XU    LIBgg02856       28/04/2005   Created
 * Guodong,XU    LIBgg31496       24/06/2005   Turn on SD_CLK to receive BG-SCAN report event
 * Guodong,XU    LIBgg38411       24/08/2005   WLAN driver traffic meter 
 * Guodong,XU    LIBgg59245       05/09/2005   Fix error generated from klocwork findings 
 * Guodong,XU    LIBgg91332       13/09/2005   Add "iwpriv eth0 mototm <x>" to en/disable TM feature
 * Guodong,XU    LIBhh02590       22/09/2005   Change the algarithm to only wake up when consecutively 
 *                                               get two tx or rx packets within 500ms.
 * Yufei,Zhang	 LIBhh17560	  13/10/2005   Added U-APSD related Feature
 * Guoodng,XU    LIBhh16098       13/10/2005   Enable Non-unicast packet receiving in IEEE power save mode
 * Yufei,Zhang	 LIBhh22889	  20/10/2005   Add data session in Power mode switch.
 * Yufei,Zhang	 LIBhh27102	  01/11/2005   Fix the bug of multiple WPRM_TM_CMD_EXIT_PS commands in Full Power mode.
 * Guodong,XU    LIBhh30893       01/11/2005   Disable broadcast packets receiving in IEEE power save mode
 * Yufei,Zhang   LIBhh24659	  08/11/2005   Fix the bug of BG_scan failure when link loss detected.
 * Guodong,XU    LIBhh72278       13/02/2006   Change exit_UAPSD commands sequence 
 */
...
int wprm_traffic_meter_service_thread(void *data)
{
	...
	/*Added by Zhang Yufei , 09/10 , For the command to enter UAPSD Mode*/
#ifdef WMM_UAPSD
