 ...
 *
 * Motorola PST USB Function Driver is Create by Levis. (Levis@motorola.com) 
 *                                                                 01/07/03
 */
...
#define NDX_OF_DATALOG_IN_EP      0x00
#define NDX_OF_AP_LOG_IN_EP       0x01
#define NDX_OF_AP_LOG_OUT_EP      0x02
#define NDX_OF_PTF_IN_EP          0x03
#define NDX_OF_PTF_OUT_EP         0x04
...
static struct usb_alternate_description pseudo_alternate_descriptionsA[] = {
	{
		iInterface:"Pseudo",
...
static struct usb_alternate_description pseudo_alternate_descriptionsB[] = {
	{
		iInterface:"Pseudo",
...
static struct usb_alternate_description pseudo_alternate_descriptionsC[] = {
	{
		iInterface:"Pseudo",
