 ...
 *
 *
 *  2003-JUL-01 - create file for Motorola PST USB Function Driver
 *
 *  2005-JUL-28 - Add PST-BULK Driver
 *
 *  2006-MAR-03 - Modified aploger flow control 
 *  
 *  2006-AUG-23 - Modified the race condition for intf8.out_msg_list in usbc_interface8_read function
 *
 *  2006-07-10 - MaxPower change to 0xFA from 0x0a for charging
 */
...
extern int motusbd_status;  // Support CFG11 bplog
#define PST_DEBUG 0 
...
/* 060710 - MaxPower change to 0xFA from 0x0a for charging*/
#undef BMAXPOWER
...
/* add ptf and ap logger alternate description(or)s*/
