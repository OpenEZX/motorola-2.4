 ...
 *  Author     Date                Comment
 * ======== ===========   =====================================================
 * Motorola 2005-Nov-11 - change for usb2.0.
 * Motorola 2005-Dec-12 - change for re-enum.
...
#define USB_DT_INTERFACE_ASSOCIATION 	   0x0B   //for IAD feature
...
// **class-specific request for uvc device**
...
#define GET_DEF          0x87
// **class-specific request for uvc device** end 
...
/* Usage Type: for USB_ENDPOINT_ISOCHRONOUS only */
#define USB_ENDPOINT_ISO_DATA           (0x00<<4)       /*Data endpoint*/
#define USB_ENDPOINT_ISO_FEEDBACK       (0x01<<4)       /*Feedback endpoint*/
#define USB_ENDPOINT_ISO_IMPLFEEDBACK   (0x02<<4)       /*Implicit feedback Data endpoint*/
#define USB_ENDPOINT_ISO_RESERVED       (0x03<<4)       /*Reserved*/

/* Synchronization Type: for USB_ENDPOINT_ISOCHRONOUS only */
#define USB_ENDPOINT_ISO_NOSYNCH        (0x00<<2)       /*No Synchronization*/
#define USB_ENDPOINT_ISO_ASYNCH         (0x01<<2)       /*Asynchronous*/
#define USB_ENDPOINT_ISO_ADAPTIVE       (0x02<<2)       /*Adaptive*/
#define USB_ENDPOINT_ISO_SYNCH          (0x03<<2)       /*Synchronous*/
...
struct usb_interface_association_descriptor{
    __u8 bLength;
    __u8 bDescriptorType;	//0x0B for IAD type
