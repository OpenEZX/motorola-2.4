 ...
 *  Date         Comment
 * =========    ==========    
 * 2005-06-16   create file to add USB 2.0 driver for Sumatra
 * 2005-07-18   Add DMA support
 * 2005-08-05   Fix: NFS is not working over USB 2.0
 * 2005-08-11   update for compliance test
 * 2005-08-19   Update USB 2 enumeration and currect consumption te based on P3B
 * 2005-08-16   add more endpoints support
 * 2005-09-09   Update ACM driver for USB2 512 max packet size
 * 2005-09-15   Mass storage read/write not via fs
 * 2005-10-14   Sumatra P3 NFS workaround
 * 2005-10-20   Setup MSC1 again after AP sleep/wakeup
 * 2005-12-28   Fix for FLASH test command
 * 2006-02-06   Fix: Phone hang in logo screen
 * 2006-02-16   Fix: USB device doesn't disappear in Windows Device Manager after power off.
 * 2006-03-21   Fix: Phone hang when pluging in charger
 * 
 */
