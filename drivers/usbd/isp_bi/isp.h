...
/* macau_iso */
#define USB_FS_ISO_MAXPKTSIZE    1023
#define USB_HS_ISO_MAXPKTSIZE    1024

/*
*	Additional transaction opportunities per microframe 
*	For high-speed isochronous and interrupt endpoints only
*	see p271 of USB20
*
*	0x00 = None (1 transaction per microframe)
*	0x01 = 1 additional (2 per microframe)
*	0x02 = 2 additional (3 per microframe)
*	0x03 = Reserved
*/
#define USB_HS_ISO_TRANS_PER_UFRAME	(0x02 << 11)
...
/* macau_iso */
#define ISP_EPTYPE_ISOCHRONOUS   0x15
