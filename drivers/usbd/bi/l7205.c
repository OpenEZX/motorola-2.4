/*
 * linux/drivers/usbd/bi/l7205.c -- L7205 USB controller driver. 
 *
...
MODULE_DESCRIPTION ("USB Device L7205 Bus Interface");
MODULE_LICENSE("GPL");
			       ...
			       volatile unsigned long reg, int offset, int request)
{
	 ...
	 */
	if (!device || !(udc_urb = usbd_alloc_urb (device, 0, 512))) {
