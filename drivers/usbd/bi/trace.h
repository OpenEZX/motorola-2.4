...
//#define CONFIG_USBD_REGISTER_TRACE
#ifdef CONFIG_USBD_REGISTER_TRACE

static __inline__ trace_t *TRACE_NEXT(trace_types_t trace_type)
{
        trace_t *p;
        ...
        p->ocsr = OSCR;
#elif defined(CONFIG_MIPS_AU1000)
        p->cp0_count = read_32bit_cp0_register(CP0_COUNT);
#elif defined(CONFIG_ARCH_SAMSUNG)
        //p->jiffies = jiffies;
