 ...
 *  Author     Date                Comment
 * ======== ===========   =====================================================
 * Motorola 2004-Dec-06 - Modified for EZXBASE.
 * Motorola 2006-Jan-10 - Add UVC support
...
#if defined(CONFIG_PM)
//#define DEBUG_USBC_PM		//USBC PM DEBUG INFO added 
#endif
			...
			case USB_STATUS_DSPLOG:
		        ...
		        case USB_STATUS_NM:
			       ...
			       len += sprintf ((char *) page + len, "\n");
                               break;
		        case USB_STATUS_UVC:
			       len += sprintf ((char *) page + len, USB_STATUS_STRING_UVC);
			       len += sprintf ((char *) page + len, "\n");
                               break;
			default:
