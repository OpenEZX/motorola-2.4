...
struct usb_alternate_description {
	...
	__u8 endpoints;
        __u8 **endpoint_list;
        int *endpoint_transferSizes_list;
};
...
struct usb_alternate_instance {
	...
	//struct usb_endpoint_descriptor *endpoint_descriptors;
	__u8 **endpoint_list;
};
...
struct usb_function_operations {
	...
	void (*event_irq) (struct usb_device_instance *, usb_device_event_t, int);
	...
	void (*function_init) (struct usb_bus_instance *, struct usb_device_instance *, 
			struct usb_function_driver *, struct usb_function_instance *);
