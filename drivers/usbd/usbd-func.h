...
struct usb_interface_description {
	...
	struct usb_interface_association_descriptor *IAD_descriptor;
#endif
};
...
void usbd_endpoint_update(struct usb_function_instance *, int , struct usb_endpoint_descriptor *, int, int);
