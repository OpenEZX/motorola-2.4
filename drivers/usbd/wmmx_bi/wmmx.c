 ...
 *
 * 2003-Dec-06 - Modified for EZXBASE 
 *
 *
...
#elif CONFIG_ARCH_EZX		//  port BMC code base to E680
...
#ifdef CONFIG_ARCH_EZX     //added for the consideration of pm
