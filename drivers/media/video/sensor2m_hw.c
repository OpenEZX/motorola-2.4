...
const static u16 awb_ccm_register_addrs[] = 
{ 
0x06, //  AWB_CCM_L_0
0x08, //  AWB_CCM_L_1
0x0A, //  AWB_CCM_L_2
...
const static u16 ccm_autoLight[] =
{ 0x0219, 0xFEEC, 0xFFFF, 0xFF6A, 0x01D4, 0xFFC9, 0xFF71, 0xFDD3, 0x03ED, 0x0020, 0x0035, 
  0xFF92, 0x0098, 0xFFE1, 0x0014, 0xFFFC, 0xFFF2, 0x004E, 0x0148, 0xFE3F, 0x000A, 0xFFF1 };

const static u16 ccm_incandescentLight[] =
{ 0x02CA, 0xFE91, 0xFFFF, 0xFF53, 0x021E, 0xFFC1, 0xFF71, 0xFE24, 0x035C, 0x0019, 0x003C, 
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000 }; 

const static u16 ccm_tl84Light[] =
{ 0x01E7, 0xFF29, 0xFFF5, 0xFF74, 0x01CB, 0xFFC5, 0xFF99, 0xFE77, 0x02F5, 0x001e, 0x0032, 
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000 }; 

const static u16 ccm_d65Light[] =
{ 0x0198, 0xFF89, 0xFFE2, 0xFF80, 0x01C8, 0xFFBD, 0xFFC0, 0xFF1C, 0x0229, 0x002B, 0x0026, 
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000 };

const static u16 ccm_cloudyLight[] =
{ 0x01CE, 0xFF43, 0xFFF0, 0xFF78, 0x01C5, 0xFFC4, 0xFFA4, 0xFEA4, 0x02BA, 0x002D, 0x0023, 
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000 };
...
{ 
    ...
    switch(light)
    {
        case V4l_WB_DIRECT_SUN:
            ...
            sensor2m_var_write8( 3 , 0x4F , 0x3F ) ;  // AWB_CCM_POSITION_MIN
            sensor2m_var_write8( 3 , 0x50 , 0x3F ) ;  // AWB_CCM_POSITION_MAX
            udelay(100);
            awb_mode = sensor2m_var_read8(3, 0x53);  
            sensor2m_var_write8(1, 0x53, awb_mode | (0x0020));

            m = ccm_d65Light;
            // change AWB ccm table
            for(i=0; i<22; i++)
            {
                sensor2m_var_write16(3, awb_ccm_register_addrs[i], m[i]);
            }

            sensor2m_var_write8( 3 , 0x4C , 0x0080 ) ; // AWB_GAIN_R
            sensor2m_var_write8( 3 , 0x4D , 0x0080 ) ; // AWB_GAIN_G
            sensor2m_var_write8( 3 , 0x4E , 0x0080 ) ; // AWB_GAIN_B
            sensor2m_var_write8( 3 , 0x51 , 0x003F ) ; // AWB_GAIN_B
            break;       
        ...
        default:
            sensor2m_var_write8( 3 , 0x4F , 0x0 ) ;  // AWB_CCM_POSITION_MIN
            sensor2m_var_write8( 3 , 0x50 , 0x7F ) ;  // AWB_CCM_POSITION_MAX
            sensor2m_var_write8( 1 , 0x02 , 0xF ) ;  
            sensor2m_var_write8( 1 , 0x2B , 0x3 ) ;  
            awb_mode = sensor2m_var_read8(1, 0x20);  
            sensor2m_var_write8(1, 0x20, awb_mode | (0x0020));
            awb_mode = sensor2m_var_read8(3, 0x53);  
...
static void sensor2m_lsc_settings(void)
{
    ...
    sensor2m_reg_write( 0x280 , 0x01A0 ) ;
    ...
    sensor2m_reg_write( 0x288 , 0x013C ) ;
    sensor2m_reg_write( 0x28B , 0x00BA ) ;
    sensor2m_reg_write( 0x28E , 0x0CA8 ) ;
    sensor2m_reg_write( 0x291 , 0x0E71 ) ;
    sensor2m_reg_write( 0x294 , 0xBE2F ) ;
    sensor2m_reg_write( 0x297 , 0x4B17 ) ;
    sensor2m_reg_write( 0x29A , 0x1B21 ) ;
    sensor2m_reg_write( 0x29D , 0x2626 ) ;
    sensor2m_reg_write( 0x2A0 , 0x2423 ) ;
    sensor2m_reg_write( 0x2A3 , 0x2928 ) ;
    sensor2m_reg_write( 0x2A6 , 0xF706 ) ;
    sensor2m_reg_write( 0x2A9 , 0x7242 ) ;
    sensor2m_reg_write( 0x289 , 0x00DB ) ;
    sensor2m_reg_write( 0x28C , 0x0083 ) ;
    sensor2m_reg_write( 0x28F , 0x0E0B ) ;
    sensor2m_reg_write( 0x292 , 0x0F3B ) ;
    sensor2m_reg_write( 0x295 , 0xD713 ) ;
    sensor2m_reg_write( 0x298 , 0x180A ) ;
    sensor2m_reg_write( 0x29B , 0x1B17 ) ;
    sensor2m_reg_write( 0x29E , 0x1E21 ) ;
    sensor2m_reg_write( 0x2A1 , 0x211D ) ;
    sensor2m_reg_write( 0x2A4 , 0x1D1B ) ;
    sensor2m_reg_write( 0x2A7 , 0x0405 ) ;
    sensor2m_reg_write( 0x2AA , 0x1413 ) ;
    sensor2m_reg_write( 0x28A , 0x00B7 ) ;
    sensor2m_reg_write( 0x28D , 0x0072 ) ;
    sensor2m_reg_write( 0x290 , 0x0E53 ) ;
    sensor2m_reg_write( 0x293 , 0x0FD8 ) ;
    sensor2m_reg_write( 0x296 , 0xCE11 ) ;
    sensor2m_reg_write( 0x299 , 0x1F09 ) ;
    sensor2m_reg_write( 0x29C , 0x1614 ) ;
    sensor2m_reg_write( 0x29F , 0x191C ) ;
    sensor2m_reg_write( 0x2A2 , 0x1718 ) ;
    sensor2m_reg_write( 0x2A5 , 0x1B18 ) ;
    sensor2m_reg_write( 0x2A8 , 0x0304 ) ;
    sensor2m_reg_write( 0x2AB , 0x161A ) ;
    sensor2m_reg_write( 0x2AC , 0x8180 ) ;
    sensor2m_reg_write( 0x2AD , 0x0000 ) ;
    sensor2m_reg_write( 0x2AE , 0x03FF ) ;
...
{
    sensor2m_var_write16( 3 , 0x06 , 0x0257 ) ;
    sensor2m_var_write16( 3 , 0x08 , 0xFFAB ) ;
    sensor2m_var_write16( 3 , 0x0A , 0xFF29 ) ;
    sensor2m_var_write16( 3 , 0x0C , 0xFF43 ) ;
    sensor2m_var_write16( 3 , 0x0E , 0x0249 ) ;
    sensor2m_var_write16( 3 , 0x10 , 0xFFA1 ) ;
    sensor2m_var_write16( 3 , 0x12 , 0xFEF3 ) ;
    sensor2m_var_write16( 3 , 0x14 , 0xFD4D ) ;
    sensor2m_var_write16( 3 , 0x16 , 0x0508 ) ;
    sensor2m_var_write16( 3 , 0x18 , 0x0022 ) ;
    sensor2m_var_write16( 3 , 0x1A , 0x0035 ) ;
    sensor2m_var_write16( 3 , 0x1C , 0xFF61 ) ;
    sensor2m_var_write16( 3 , 0x1E , 0x1A ) ;
    sensor2m_var_write16( 3 , 0x20 , 0x0085 ) ;
    sensor2m_var_write16( 3 , 0x22 , 0x0049 ) ;
    sensor2m_var_write16( 3 , 0x24 , 0xFFD4 ) ;
    sensor2m_var_write16( 3 , 0x26 , 0xFFE9 ) ;
    sensor2m_var_write16( 3 , 0x28 , 0x00DE ) ;
    sensor2m_var_write16( 3 , 0x2A , 0x019B ) ;
    sensor2m_var_write16( 3 , 0x2C , 0xFD6F ) ;
    sensor2m_var_write16( 3 , 0x2E , 0x000A ) ;
    sensor2m_var_write16( 3 , 0x30 , 0xFFF1 ) ;
    sensor2m_var_write8( 3 , 0x61 , 0x00E2 ) ;
    sensor2m_var_write8( 3 , 0x62 , 0x00F0 ) ;
    return 0 ;
}
...
int sensor2m_default_settings()
{
    ...
    sensor2m_var_write8(7,  71, 0x023);
    sensor2m_var_write8(7,  72, 0x03A);
    sensor2m_var_write8(7,  73, 0x05E);
    sensor2m_var_write8(7,  74, 0x076);
    sensor2m_var_write8(7,  75, 0x088);
    sensor2m_var_write8(7,  76, 0x096);
    sensor2m_var_write8(7,  77, 0x0A3);
    sensor2m_var_write8(7,  78, 0x0AF);
    sensor2m_var_write8(7,  79, 0x0BA);
    sensor2m_var_write8(7,  80, 0x0C4);
    sensor2m_var_write8(7,  81, 0x0CE);
    sensor2m_var_write8(7,  82, 0x0D7);
    sensor2m_var_write8(7,  83, 0x0E0);
    sensor2m_var_write8(7,  84, 0x0E8);
    sensor2m_var_write8(7,  85, 0x0F0);
    sensor2m_var_write8(7,  86, 0x0F8);
    sensor2m_var_write8(7,  87, 0x0FF);
    sensor2m_var_write8(7,  88, 0x000);
    sensor2m_var_write8(7,  89, 0x014);
    sensor2m_var_write8(7,  90, 0x023);
    sensor2m_var_write8(7,  91, 0x03A);
    sensor2m_var_write8(7,  92, 0x05E);
    sensor2m_var_write8(7,  93, 0x076);
    sensor2m_var_write8(7,  94, 0x088);
    sensor2m_var_write8(7,  95, 0x096);
    sensor2m_var_write8(7,  96, 0x0A3);
    sensor2m_var_write8(7,  97, 0x0AF);
    sensor2m_var_write8(7,  98, 0x0BA);
    sensor2m_var_write8(7,  99, 0x0C4);
    sensor2m_var_write8(7, 100, 0x0CE);
    sensor2m_var_write8(7, 101, 0x0D7);
    sensor2m_var_write8(7, 102, 0x0E0);
    sensor2m_var_write8(7, 103, 0x0E8);
    sensor2m_var_write8(7, 104, 0x0F0);
    sensor2m_var_write8(7, 105, 0x0F8);
