...
Revision History:
   ...
   ------------   -------------------------
    ...
    8/20/2006      change sensor settings
...
{ 0x0026, 0x3923, 0x0524, 0x0080, 0x0000, 0x0000, 0x0058, 0x00AC,
  0x0000, 0x003B, 0x009C, 0x0076, 0x002D, 0x0000, 0x0000, 0x0000,
  0x0016, 0x000F, 0x0007, 0x0006, 0x00A0, 0x0026, 0x684F, 0x3D29,
  0x0002 };

const static u16 incandescentLight[] =
{ 0x0026, 0x3923, 0x0524, 0x0080, 0x0000, 0x0000, 0x004D, 0x00A4,
  0x0003, 0x0038, 0x00ED, 0x0089, 0x0000, 0x0000, 0x0000, 0x0000,
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x882F, 0x0000,
  0x0000 };

const static u16 tl84Light[] =
{ 0x0026, 0x3923, 0x0724, 0x0080, 0x0000, 0x0000, 0x0053, 0x00A9,
  0x0001, 0x003A, 0x00BC, 0x00FB, 0x0000, 0x0000, 0x0000, 0x0000,
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x693C, 0x0000,
  0x0000 };

const static u16 d65Light[] =
{ 0x002E, 0x3923, 0x0724, 0x0080, 0x0000, 0x0000, 0x0063, 0x00B3,
  0x0004, 0x003E, 0x004C, 0x00C5, 0x0000, 0x0000, 0x0000, 0x0000,
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x4A57, 0x0000,
  0x0000 };
...
static void sensor13m_lsc_settings(void)
{
    ...
    sensor13m_write(0x181, 0xD513);    
    sensor13m_write(0x182, 0xECE3);    
    sensor13m_write(0x183, 0xFCF8);    
    sensor13m_write(0x184, 0xDE10);    
    sensor13m_write(0x185, 0xF1E8);    
    sensor13m_write(0x186, 0xFFF3);    
    sensor13m_write(0x187, 0xE00E);    
    sensor13m_write(0x188, 0xF1E9);    
    sensor13m_write(0x189, 0xFFF8);    
    sensor13m_write(0x18A, 0xC020);    
    sensor13m_write(0x18B, 0xE6D1);    
    sensor13m_write(0x18C, 0xF6EC);    
    sensor13m_write(0x18D, 0x00FD);    
    sensor13m_write(0x18E, 0xD719);    
    sensor13m_write(0x18F, 0xE6DF);    
    sensor13m_write(0x190, 0xF7EF);    
    sensor13m_write(0x191, 0x00FC);    
    sensor13m_write(0x192, 0xD517);    
    sensor13m_write(0x193, 0xEBDF);    
    sensor13m_write(0x194, 0xF7F3);    
    sensor13m_write(0x195, 0x00FF);    
    sensor13m_write(0x1B6, 0x0D04);    
    sensor13m_write(0x1B7, 0x2416);    
    sensor13m_write(0x1B8, 0x0A03);    
    sensor13m_write(0x1B9, 0x1610);    
    sensor13m_write(0x1BA, 0x0902);    
    sensor13m_write(0x1BB, 0x1D0D);    
    sensor13m_write(0x1BC, 0x0B04);    
    sensor13m_write(0x1BD, 0x2217);    
    sensor13m_write(0x1BE, 0x0033);    
    sensor13m_write(0x1BF, 0x0A04);    
    sensor13m_write(0x1C0, 0x1A12);    
    sensor13m_write(0x1C1, 0x001E);    
    sensor13m_write(0x1C2, 0x0803);    
    sensor13m_write(0x1C3, 0x1810);    
    sensor13m_write(0x1C4, 0x001F);    
