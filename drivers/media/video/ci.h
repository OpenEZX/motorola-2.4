/*
 *  linux/drivers/media/video/pxa_camera.h
 *
 *  Bulverde Processor Camera Interface driver header.
 *
 ...
 *
 *  Jan 16,2004 - (Motorola) Created new file based on the pxa_camera.h file
 */
