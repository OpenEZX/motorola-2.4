 ...
 *
 * 11/25/2004 Fix some bugs and re-organize the file.
 * 03/15/2006 make supporting of multiple keypress a option
 * 10/10/2005 add kernel panic triggger
 * 03/30/2006 disable the mutiple keypress for sumatra
 * 09/07/2006 disable the kernel panic log trigger for martinique
 */
...
/* Disable kernel panic log trigger for martinique*/
#ifndef CONFIG_KEYPAD_MARTINIQUE
/* 
 * panic log trigger
 * NOTE: must also enable KEYPAD_MULTIPLE_KEYPRESS_SUPPORT
 */
#define KEYPAD_TRIGGER
#endif /* CONFIG_KEYPAD_MARTINIQUE */
