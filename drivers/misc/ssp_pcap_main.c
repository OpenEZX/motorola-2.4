...
/* REVISION HISTORY 
	...
	========      ==========		==========================
	2002-07-02    Motorola 		create
        2004-02-09    Motorola          update PM for Bulverde OS
        2004-04-13    Motorola          update accessory usb attach and detach
        2004-04-27    Motorola	        send the USB accessory detach/attach information to PM
        2004-05-11    Motorola          after sleep TC_MM_EN will be high else will be low
        2004-06-24    Motorola          remove the SSP_PCAP_configure_USB_UART_transeiver()
        2004-08-19    Motorola          after sleep set SW1 output 1.3V and low power mode and when headset button press/release, send an event to PM 
        2004-08-31    Motorola          remove the headset button press/release event to PM.
        2004-11-19    Motorola          add some code to support PRIMARY SPI configure.
	2004-12-15    Motorola  	BARBADOS HANDSHAKE UPDATE 
        2005-05-12    Motorola          remove warning code.
*/
