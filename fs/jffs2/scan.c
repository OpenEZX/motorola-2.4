 ...
 * 2005/01	   Modified for ezx platform  	
 * 2005/04/13	   Motorola imply summary patch  	
 * 2005/10/11	   Mount record interface for ignoring crc check 
 * 2006/03/13	   update CRC patch 
 *
...
int jffs2_scan_medium(struct jffs2_sb_info *c)
{
	...
	/* Check for the very first time mounting after code flashing */
