 ...
 *
 * 2005/12/02     Added to count the file real size ocuppied on flash 
 * 2006/03/20     fix crc issue
 *
...
#ifdef CONFIG_ARCH_EZXBASE
void jffs2_obsolete_node_frag(struct jffs2_sb_info *c, struct jffs2_inode_info *f, struct jffs2_node_frag *this) 
#else
