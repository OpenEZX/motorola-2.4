 ...
 *    2005-05-04  Add security patch
 *    2005-08-20  mtd polish
 */
...
#if defined (CONFIG_ARCH_EZX_SUMATRA) || defined(CONFIG_ARCH_EZX_MARTINIQUE)
	__REG(0x58000010)=0;
#endif
	sched_init();
	softirq_init();
...
#ifdef CONFIG_ARCH_EZX
        /* this must be done before time_init() */
        //ssp_pcap_init();
#endif
