...
#================================================================================
#
#  Copyright © 2003,2005-2006 Motorola
# 
...
# ----------------   ------------   -------------------------------
# Motorola           11/22/2003    Created   
# Motorola           09/28/2005    Added paniclog  
# Motorola           12/20/2005    Modified panic cmdline value
# Motorola           12/21/2005    Add Macau support
# Motorola           06/15/2006    Add PENGLAI support 
# Motorola           11/01/2006    Add Macau EDGE support 
# Motorola           12/05/2006    Change MACAUE to MACAUEDGE
cd ./include
...
case "$1" in
	...
	;;
    PRODUCT=HAINANEDGE)
        make ezx-hainane_config
	;;
    PRODUCT=MACAU)
        make ezx-macau_config
	;;
    PRODUCT=MACAUEDGE)   #MACAUEDGE, MACAUE, macaue, macauedge are refering to same thing
        make ezx-macaue_config
	;;
    PRODUCT=PENGLAI)
        make ezx-penglai_config
	;;
    PRODUCT=BARBADOS)
    ...
    ?)
        ...
        echo "        PRODUCT=HAINANEDGE	(HAINANEDGE)"
        echo "        PRODUCT=MACAU	(MACAU)"
        echo "        PRODUCT=MACAUEDGE	(MACAUEDGE)"
        echo "        PRODUCT=PENGLAI	(PENGLAI)"
        ...
        ;;
    *)
        echo "usage:  ./setup.sh [PRODUCT=E680|PRODUCT=E680I|PRODUCT=A780|PRODUCT=SUMATRA|PRODUCT=SUMATRAI|PRODUCT=HAINAN|PRODUCT=MACAU|PRODUCT=PENGLAI|PRODUCT=BARBADOS|PRODUCT=MARTINIQUE| ?]"
	exit 1
	;;
esac
