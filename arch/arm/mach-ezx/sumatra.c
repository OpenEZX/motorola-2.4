/*
 *  linux/arch/arm/mach-ezx/sumutra.c
 *
 ...
 *
 *  2005-03-13  Created file
 *  2005-06-30  update pcap interface to spi mode
 *  2005-07-11  update (barbados p4) flip gpio to 15
 *  2005-08-26  bprdy interrupt reentry protect mechanism
 *  2005-09-20  adjust sleep condition
 *  2005-09-28  keep the GPIO_BB_FLASHMODE_EN in LOW when phone enter sleep 
 *              mode.
 *  2005-10-17  Fix: interrupt are lost when phone turns off irq and begin 
 *              to sleep
 *  2005-10-27  Move Logo displaying to MBM
