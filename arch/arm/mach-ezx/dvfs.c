 ...
 *
 * history:
 * 2005/10/20  change mdrefr
 * 2005/12/31  ipm tune for ezx platform
 * 2006/07/19  support macau and penglai
...
#if defined(CONFIG_ARCH_EZX_HAINAN) || defined(CONFIG_ARCH_EZX_SUMATRA) || defined(CONFIG_ARCH_EZX_MACAU) || defined(CONFIG_ARCH_EZX_PENGLAI)
