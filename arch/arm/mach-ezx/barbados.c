 ...
 *
 *
 * 2005-Jun-30 update pcap interface tospi mode
 *
 * 2005-Dec-22 keep gpio99 to low
 */
...
void handshake(void)
{
	 if (step == 1) {
		 if (GPIO_is_high(GPIO_BP_RDY)) {
			 step ++;
#if 0  // This part work has been transfered to MBM, and this fragment will be deteleted after system is stable.
		     {
