 ...
 *  2005-04-28  Set rtc time. 
 *  2005-05-12  Added time irq. 
 *  2005-07-21  Added power ic rtc. 
 *  2005-12-27  Fixed do_set_rtc. 
 */
...
/* also used in arch/arm/mach-ezx/pm.c, when xtime synced to PCAP RTC */
long next_rtc_update;
