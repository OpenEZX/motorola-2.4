...
/* UDCCR_REM -- reset interrupt enable mask, this means if the host reset the UDC, 
 *              UDC won't generate an interrupt
 * UDCCR_SRM -- suspend/resume interrupt enable maask, this means the UDC won't
 *              generate an interrupt when UDC enter suspend/resume mode.
 */
