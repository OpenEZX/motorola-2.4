 ...
 *
 * 2004-Mar-10 - (Motorola) Added #include directive
 */
 ...
 * Note: the exact virtual address specified in arch/arm/Makefile
 * *must* match with this (currently set to VMALLOC_END).
 */
#ifdef CONFIG_XIP_ROM
#define KERNEL_XIP_BASE_PHYS   (CONFIG_XIP_PHYS_ADDR & 0xffe00000)
#define KERNEL_XIP_BASE_VIRT   VMALLOC_END
#endif
