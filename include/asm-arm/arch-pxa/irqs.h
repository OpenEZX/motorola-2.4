...
#define	IRQ_GPIO_2_120	PXA_IRQ(10)	/* GPIO[2-120] Edge Detect */
...
#define GPIO_2_120_TO_IRQ(x)	\
			PXA_IRQ((x) - 2 + 64)
#define IRQ_GPIO(x)	(((x) < 2) ? (IRQ_GPIO0 + (x)) : GPIO_2_120_TO_IRQ(x))

#define IRQ_TO_GPIO_2_120(i)	\
			((i) - PXA_IRQ(64) + 2)
#define IRQ_TO_GPIO(i)	((i) - (((i) > IRQ_GPIO1) ? IRQ_GPIO(2) : IRQ_GPIO(0)))

#define BT_HOSTWAKE	GPIO_2_120_TO_IRQ(GPIO_BT_HOSTWAKE)
#undef NR_IRQS
#define	NR_IRQS		(IRQ_GPIO(120) + 1)
...
#define MAINSTONE_IRQ(x)	(IRQ_GPIO(80) + 1 + (x))
