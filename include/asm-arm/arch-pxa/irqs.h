...
#else
#define PXA_IRQ_SKIP	7	/* The first 7 IRQs are reserved */
#endif
...
#define IRQ_ASSP	PXA_IRQ(15)	/* ASSP interrupt */
#define IRQ_NSSP	PXA_IRQ(16)	/* NSSP interrupt */
...
#define BT_HOSTWAKE     GPIO_2_80_TO_IRQ(GPIO13_BT_HOSTWAKE)
