 ...
 * Date       	  	Comment
 * ========    		=================================
 * 09/23/2003   	Add the Bulverde SSP micro
 * 10/24/2003 		Added three USB-related registers
 * 01/02/2003 		Port ssp part from UDC e680 kernel of jem vob; redefine some ssp gpio
 *                                       pin macros to more portable mode.
 * 03/15/2004 		fix the bug: assp and nssp port can not work at the same time
 * 03/15/2006 		Add some Keypad macros.
 * 10/16/2006 		Add a RTSR status bits mask macro.
 *
 */
...
/* Caution: For RTSR status bits, write 0b1 to clear them. For 
 * example, the following code is incorrect to enable SWCE.
 *
 *           RTSR |= RTSR_SWCE;  
 *
 ...
 */
#define RTSR_STATUS_BITS_MASK 0xdaac 
