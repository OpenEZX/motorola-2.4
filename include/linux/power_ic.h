 ...
 * ----------------    -------------------------
 *  03/20/2004         create file
 *  09/07/2005        Missing defines for EMU accessories in power_ic.h
 *  11/22/2005        update PCAP2 init value for product HAINAN and Martinique.
 *  11/28/2005        Port TCMD ioctl calls for SCM-A11
 *
 */
