/*
 * /vobs/ezx_linux/code/linux/linux-2.4.17/include/linux/power_ic.h
 *
 * Description - Power IC driver
 *
 ...
 *
 * Motorola 2006-May-31 - Fix x86 compliance
 ...
 * Motorola 2005-May-12 - Touchscreen and TCMD support
 ...
 *
 * This command takes no inputs. (The int is unused in the IOCTL call)
 * 
 * This command has no output other than the returned error code for the ioctl() call.
 */ 
#define POWER_IC_IOCTL_PERIPH_SET_WLAN_LOW_POWER_STATE_ON \
        _IOW(POWER_IC_MAJOR_NUM, (POWER_IC_IOC_CMD_PERIPH_BASE + 0x05), int)
...
/* These IOCTLs do not take an input. (The int is unused in the IOCTL call) */
#define POWER_IC_IOCTL_AUDIO_POWER_OFF \
        _IOW(POWER_IC_MAJOR_NUM, (POWER_IC_IOC_CMD_AUDIO_BASE + 0x14), int)
#define POWER_IC_IOCTL_AUDIO_ST_DAC_RESET \
        _IOW(POWER_IC_MAJOR_NUM, (POWER_IC_IOC_CMD_AUDIO_BASE + 0x15), int)
#define POWER_IC_IOCTL_AUDIO_CODEC_RESET \
        _IOW(POWER_IC_MAJOR_NUM, (POWER_IC_IOC_CMD_AUDIO_BASE + 0x16), int)
#define POWER_IC_IOCTL_AUDIO_VAUDIO_ON \
        _IOW(POWER_IC_MAJOR_NUM, (POWER_IC_IOC_CMD_AUDIO_BASE + 0x17), int)
/* @} End of Audio ioctls.  -----------------------------------------------------------------------*/
 ...
 *
 * The command takes no inputs.  (The int is unused in the IOCTL call)
 *
 * The command has no output other than the returned error code for the ioctl() call.
 */ 
#define POWER_IC_IOCTL_TS_ENABLE \
        _IOW(POWER_IC_MAJOR_NUM, (POWER_IC_IOC_CMD_TOUCHSCREEN_BASE + 0x00), int)
...
#define POWER_IC_IOCTL_TS_DISABLE \
        _IOW(POWER_IC_MAJOR_NUM, (POWER_IC_IOC_CMD_TOUCHSCREEN_BASE + 0x01), int)
