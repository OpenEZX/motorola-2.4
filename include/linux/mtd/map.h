...
struct map_info {
	...
	/*This function should invalidate all cache lines that include the address space from startaddress to startaddress + length*/
	void (*invalidate_cache)(unsigned long startaddress, unsigned long length);
#endif
