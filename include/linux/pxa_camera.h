...
----------------   -------------------------
  ...
  11/01/2004         Change to SDK style
  07/26/2005         Adjusting light, style or mode is noneffective. 
  08/04/2005         Add camera strobe flash to 1.3MP camera driver for Sumatra first phase
  11/09/2005         add color styles and cloudy white blance
...
#define CAMERA_IMAGE_FORMAT_JPEG_SENSOR        20
