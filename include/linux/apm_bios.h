 ...
 *
 * modified for EZX platform
 * 
 * 2006-04-27 	Add a new interface for other component to request sleep.
 * 2006-05-15 	Add an IOCTL to get flip status during pwrup to fix black screen issue at opening flip during pwrup
 */
...
#define APM_EVENT_REQ		0x3		/*	request events. */
...
#define	APM_IOC_GET_PWRUP_FLIP		_IOR('A', 18, int) /*get flip status during pwrup*/
...
extern void apm_req_sleep(int info);
