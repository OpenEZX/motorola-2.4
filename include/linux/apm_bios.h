 ...
 *
 * modified by motorolan for EZX platform
 *
 * 2006-05-10  Motorolan  Add CONFIG_APM_ISP macro for ipm improvement
 */
...
enum periodic_ignore_event{
  IGNORE_START = 0,
  PCAP_ATOD,
};

extern void apm_inc_ignore_int(enum periodic_ignore_event  event);
extern void apm_clear_ignore_int(void);
extern int apm_get_ignore_num(void);
