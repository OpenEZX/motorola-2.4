...
typedef struct
{
    unsigned int nData;   /* Data which can be used by the control functions to change operation based on the region. */
    void *pGeneric;       /* Pointer to an implementation defined function or data pointer. */
} LIGHTS_FL_LED_CTL_T;

/*
 * Structure used to configure the regions for different products.
 */
typedef struct
{
