 ...
 * Revision history:
 *
 * 2005-Apr-05 Add security patch, 
 * 2006-March-13 change buffer size,
 * 2006-Mar-28 Change the log buf length for kernel panic log,
 *             Add the jiffies on the beginning of every line                          
 */
...
#define LOG_BUF_LEN     (65536)		/* below LOGO_SIZE */
#else
...
asmlinkage int printk(const char *fmt, ...)
{
	...
	jiffies_len = snprintf(print_jiffies, sizeof(print_jiffies),
				"T[%ld]", jiffies);
#endif
	va_start(args, fmt);
