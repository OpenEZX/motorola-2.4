 ...
 *  Copyright (C) 1991, 1992  Linus Torvaldsi
 *
 ...
 *  Author     Date                Comment
 * ======== ===========   =====================================================
 * Motorola 2006-Aug-24 - Bug fix:current->user->processes leak in reparent_to_init().
 * Motorola 2005-Apr-04 - Add security patch.  
 */
...
void reparent_to_init(void)
{
	...
	memcpy(current->rlim, init_task.rlim, sizeof(*(current->rlim)));
        ...
        {
            /*
            * This is a kernel bug,Linux 2.4.23 had fixed it.
            * ChangeLog in Linux 2.4.23
            *   <eric:lammerts.org>: fix current->user->processes leak in reparent_to_init()
            * Detail description: http://www.kernel.org/pub/linux/kernel/people/akpm/patches/2.5/
            *                        2.5.59/2.5.59-mm10/broken-out/user-process-count-leak.patch
            */
           struct user_struct *old_user = current->user;
           struct user_struct *new_user = INIT_USER;
