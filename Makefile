...
EXTRAVERSION = $(shell if [ -f .hhl_target_lspname ]; then \
				echo "_mvl30-`cat .hhl_target_lspname`"; \
		       else \
				echo "_mvl30"; \
		       fi)
...
ifeq ($(DBG),1)
CFLAGS		+=-D_DEBUG_BOARD
AFLAGS		+=-D_DEBUG_BOARD
endif
...
DRIVERS-y += drivers/char/char.o \
	...
	drivers/CEBus_chardev/CEBus_chardev.o
...
DRIVERS-$(CONFIG_MMCPXA250) += drivers/mmcpxa250/mmcpxa250.o
...
# Added by Susan
DRIVERS-$(CONFIG_ROFLASH) += drivers/block/roflash/roflash.a
# End of modification
...
include/linux/compile.h: $(CONFIGURATION) include/linux/version.h newversion
	...
	@echo ' 'Jan 1,2003 \" >> .ver
	@echo \#define LINUX_COMPILE_TIME \"10:00:00 \" >> .ver
	@echo \#define LINUX_COMPILE_BY \"BJDC\" >> .ver
	@echo \#define LINUX_COMPILE_HOST \"EZX\" >> .ver
	...
	@echo \#define LINUX_COMPILER \"Gcc 3.2.1 for Xscale\" >> .ver
	@mv -f .ver $@
...
clrdbg:
	rm -f drivers/video/pxafb.o
	rm -f drivers/video/video.o
	rm -f drivers/ssp/ssp_pcap_main.o
	rm -f drivers/ssp/ssp.o
	rm -f drivers/CEBus_chardev/CEBus_chardev.o
