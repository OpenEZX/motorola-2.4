...
static void ircomm_tty_ias_register(struct ircomm_tty_cb *self)
{
    ...
    obj_pnp = irias_new_object("PnP", IAS_PNP_ID);
    irias_add_string_attrib(obj_pnp, "Name", "A760", IAS_KERNEL_ATTR);
    irias_add_string_attrib(obj_pnp, "DeviceID", "MOT0002",IAS_KERNEL_ATTR);
    irias_add_integer_attrib(obj_pnp, "CompCnt", 1, IAS_KERNEL_ATTR);
    irias_add_string_attrib(obj_pnp, "Comp#01", "PNPC103",IAS_KERNEL_ATTR);
    irias_add_string_attrib(obj_pnp, "Manufacturer","Motorola", IAS_KERNEL_ATTR);
    irias_insert_object(obj_pnp);
